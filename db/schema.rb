...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "bookings", primary_key: "book_ref", id: { type: :string, limit: 6, comment: "Booking number" }, comment: "Bookings", force: :cascade do |t|
    t.datetime "book_date", null: false, comment: "Booking date"
  ...
  create_table "flights", primary_key: "flight_id", id: { type: :serial, comment: "Flight ID" }, comment: "Flights", force: :cascade do |t|
    ...
    t.datetime "scheduled_departure", null: false, comment: "Scheduled departure time"
    t.datetime "scheduled_arrival", null: false, comment: "Scheduled arrival time"
    ...
    t.datetime "actual_departure", comment: "Actual departure time"
    t.datetime "actual_arrival", comment: "Actual arrival time"
